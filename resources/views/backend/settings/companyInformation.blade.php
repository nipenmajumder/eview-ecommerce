        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                ...
                <form class="form" method="POST" id="kt_layout_builder_form"
                    action="{{ route('admin.companyInformation') }}" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Body-->
                    <div class="card-body" data-select2-id="select2-data-90-elj6">
                        <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                            <div class="tab-pane active" id="kt_builder_main"
                                ...
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">Company Name:<span
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="text"
                                                name="company_motto" value="{{$edit->company_motto}}"
                                                placeholder="Company Motto">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">Company Address :</label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="text"
                                                name="company_address" value="{{$edit->company_address}}"
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="email" name="email"
                                                value="{{$edit->email}}" placeholder="Company Email">
                                        </div>
                                        @error('email')
                                        <div class="validation">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">Mobile:<span
                                            class="validation">*</span></label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="text" name="mobile"
                                                value="{{$edit->mobile}}" placeholder="Company Mobile">
                                        </div>
                                        @error('mobile')
                                        <div class="validation">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="text" name="telephone"
                                                value="{{$edit->telephone}}" placeholder="Company Telephone">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url({{asset('uploads/logo/'.$edit->logo)}})">
                                            </div>
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <!--begin::Preview existing avatar-->
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url({{asset('uploads/logo/'.$edit->favicon)}})">
                                            </div>
                                            <!--end::Preview existing avatar-->
                                            <!--begin::Label-->
                                            <label
