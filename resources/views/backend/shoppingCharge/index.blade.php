...
@section('title', ' Shopping Charge List')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Shopping Charge</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Shopping Charge Manage</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                {{-- <a href="{{ url('admin/slider/create') }}" class="btn btn-sm btn-primary">Create
                                    Slider</a> --}}
                            </div>
                        </div>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3"
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-120px">Charge</th>
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="{{url('admin/shopping-charge/edit',$data->id)}}"
