        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Brand Manage</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Brand</span>
                                <!-- <span class="text-muted mt-1 fw-bold fs-7">Over 500 orders</span> -->
                            </h3>
                            <div class="card-toolbar">
                                
                                <a href="{{ url('admin/brand/create') }}" class="btn btn-sm btn-primary">Create brand</a>
                            </div>
                        </div>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%">
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px">Brand Name</th>
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                               <img src="{{asset('uploads/brand/'.$data->image)}}" height="25px">
                                            </td>
                                            ...
                                            <td class="text-end">
                                                @if($data->is_active==1)
                                                <a href="{{url('admin/brand/deactive/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    <i class="fa fa-thumbs-up green"></i>
                                                </a>
                                                @else
                                                <a href="{{url('admin/brand/active/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fa fa-thumbs-down red"></i>
                                                </a>
                                                @endif
                                                <a href="{{url('admin/brand/edit/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fas fa-pen-square blue"></i>
                                                </a>
                                                <a id="delete" href="{{url('/admin/brand/delete/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
