    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">terms and conditions</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update terms and conditions</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ route('admin.about-us.update') }}" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-8">
                                                <div
                                                    ...
                                                    <textarea id="summernote" name="details" cols="30" rows="40"
                                                        class="details" height="160px">{{ $data->details }}</textarea>
