        ...
        <div id="kt_content_container" class="container">
                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6 active" href="{{route('admin.ProfileUpdate')}}">Settings</a>
                            </li>
                        </ul>
                    </div>
                    <!--begin::Navs-->
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form action="{{route('admin.ProfileUpdate')}}" method="POST" id="" class="form" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Card body-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(assets/media/avatars/blank.png)">
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{asset('uploads/adminimage/'.Auth::user()->image)}})"></div>
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-10">
                            <div id="kt_signin_password_edit" class="flex-row-fluid">
                                <!--begin::Form-->
                                <form action="{{ route('admin.adminUpdatePassword') }}" method="post" class="form" novalidate="novalidate">
                                    @csrf
                                    <div class="row mb-1">
                                        <div class="col-lg-4">
                                            <div class="fv-row mb-0">
