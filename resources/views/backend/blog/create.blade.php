    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Blog</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Create Blog</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                        ...
                        <div class="card-header card-header-stretch overflow-auto row text-right">
                            ...
                            <div class="col-md-2 text-right">
                                ...
                                <div class="mt-5" style="margin-left: 75px">
                                    <a href="{{ url('/admin/blog/index') }}" class="btn btn-primary">All Blogs</a>
                                </div>
                            </div>
                        </div>
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ url('/admin/blog/store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main"
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Blog Title:</label>
                                            <div class="col-lg-9 col-xl-9">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text"
                                                        name="title" placeholder="Enter Blog Title">
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Image:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                        style="background-image: url({{asset('public/uploads/logo/')}})">
                                                    </div>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <textarea id="summernote" name="des" cols="30" rows="40"
                                                        class="details" height="160px"></textarea>
                                                </div>
                                                @error('des')
                                                <div class="validation">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Blog Tag:</label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input name="tag" id="tags" data-role="tagsinput"
                                                        class="form-control form-control-solid tags" type="text"
                                                        placeholder="Tag">
                                                </div>
                                                @error('tag')
                                                <div class="validation">{{ $message }}</div>
