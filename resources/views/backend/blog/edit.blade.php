        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Edit Blog</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ url('/admin/blog/update',$blog->id) }}" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <div
                                                    ...
                                                    <textarea id="summernote" name="des" cols="30" rows="40"
                                                        class="details" height="160px">{{ $blog->des }}</textarea>
                                                </div>
                                                @error('des')
                                                <div class="validation">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div
                                                    ...
                                                    <input name="tag" id="tags" data-role="tagsinput"
                                                        ...
                                                        placeholder="Tag" value="{{ $blog->tag }}">
                                                </div>
                                                @error('tag')
                                                <div class="validation">{{ $message }}</div>
                                                @enderror
