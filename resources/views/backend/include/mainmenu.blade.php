		...
		<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if(request()->routeIs('admin.subcategory*')) here show @endif">
				...
				<div class="menu-sub menu-sub-accordion menu-active-bg">
					...
					<div class="menu-item">
						<a class="menu-link {{ request()->routeIs('admin.subcategory.index*') ? 'active' : '' }}" href="{{ url('/admin/subcategory/create') }}">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if(request()->routeIs('admin.re-resubcategory*')) here show @endif">
				<span class="menu-link">
					<span class="menu-icon">
						<i class="bi bi-layers fs-3"></i>
					</span>
				...
				<div class="menu-sub menu-sub-accordion menu-active-bg">
					<div class="menu-item">
						<a class="menu-link {{ request()->routeIs('admin.re-resubcategory.create*') ? 'active' : '' }}"  href="{{ url('/admin/re-resubcategory/create') }}">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
					...
					<div class="menu-item">
						<a class="menu-link {{ request()->routeIs('admin.re-resubcategory.index*') ? 'active' : '' }}" href="{{ url('/admin/re-resubcategory/index') }}">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if(request()->routeIs('admin.re-re-resubcategory*')) here show @endif" ">
				<span class="menu-link">
					<span class="menu-icon">
						<i class="bi bi-layers fs-3"></i>
					</span>
				...
				<div class="menu-sub menu-sub-accordion menu-active-bg">
					<div class="menu-item">
						<a class="menu-link {{ request()->routeIs('admin.re-re-resubcategory.create*') ? 'active' : '' }}"  href="{{ url('/admin/re-re-resubcategory/create') }}">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
					...
					<div class="menu-item">
						<a class="menu-link {{ request()->routeIs('admin.re-re-resubcategory.index*') ? 'active' : '' }}" href="{{ url('/admin/re-re-resubcategory/index') }}">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if(request()->routeIs('admin.re-re-resubcategory*')) here show @endif" ">
				...
				<div class="menu-sub menu-sub-accordion menu-active-bg">
					<div class="menu-item">
						<a class="menu-link {{ request()->routeIs('admin.brand.create*') ? 'active' : '' }}"  href="{{ url('/admin/brand/create') }}">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
					...
					<div class="menu-item">
						<a class="menu-link {{ request()->routeIs('admin.brand.index*') ? 'active' : '' }}" href="{{ url('/admin/brand/index') }}">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
