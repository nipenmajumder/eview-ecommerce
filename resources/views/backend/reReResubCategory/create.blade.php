...
@section('title', 'Create ReReSubCategory')
@section('content')
<style>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Create ReSubCategory Three</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-stretch overflow-auto row text-right">
                           ...
                           <div class="mt-5" style="margin-left:">
                                    <a href="{{ route('admin.re-re-resubcategory.index') }}" class="btn btn-primary">All ReSubCategory Three</a>
                                </div>
                           </div>
                        </div>
                        <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.re-re-resubcategory.create') }}" enctype="multipart/form-data">
                            @csrf
                                                ...
                                                <div class="col-lg-9 col-xl-4">
                                                    <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                        <select name="category" id="category" class="form-control form-control-solid">
                                                            ...
                                                            <option value="{{ $caegory->id }}">{{ $caegory->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    @error('category')
            ...
            if (resubcate_id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#reresubcategory').empty();
                        $('#reresubcategory').append(' <option value="">--select--</option>');
                        $.each(data, function(index, districtObj) {
                            $('#reresubcategory').append('<option value="' + districtObj.id + '">' + districtObj.name + '</option>');
                        });
