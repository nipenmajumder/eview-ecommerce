    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">ReSubCategory Three Update</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update ReSubCategory Three</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header card-header-stretch overflow-auto row text-right">
                           ...
                           <div class="mt-5" style="margin-right:10px">
                                    <a href="{{ route('admin.re-re-resubcategory.index') }}" class="btn btn-primary">All Item</a>
                                </div>
                           </div>
                        </div>
                        <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.re-re-resubcategory.update') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <select name="subcategory" id="subcategory" class="form-control form-control-solid">
                                                            ...
                                                            @foreach($allSubCategory as $subcategory)
                                                                @if($edit->category==$subcategory->category)
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <select name="resubcategory" id="resubcategory" class="form-control form-control-solid">
                                                            ...
                                                            <option value="{{ $resubcategory->id }}" @if($edit->re_sub_category==$resubcategory->id) selected @endif>{{ $resubcategory->name }}</option>
                                                            @endforeach
                                                    </select>
                                                </div>
                                                @error('subcategory')
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">ReSubCategory Two:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <select name="reresubcategory" id="reresubcategory" class="form-control form-control-solid">
                                                        <option selected disabled>--select--</option>
                                                            @foreach($allReReSubCategory as $reresubcategory)
                                                                <option value="{{ $reresubcategory->id }}" @if($edit->re_re_sub_category==$reresubcategory->id) selected @endif>{{ $reresubcategory->name }}</option>
                                                            @endforeach
                                                    </select>
                                                </div>
                                                @error('resubcategory')
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                   <input type="text" class="form-control" name="name" value="{{ $edit->name }}" placeholder="Enter Re-ResubCategory">
                                                </div>
                                                @error('name')
                                                        <div class="validation">{{ $message }}</div>
                                               @enderror
