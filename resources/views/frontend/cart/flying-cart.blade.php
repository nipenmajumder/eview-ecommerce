...
<div class="d-flex flex-row justify-content-between align-items-center p-2 bg-white px-3 rounded">
    <div class="mr-1">
        ...
        @if($key==0)
        <img class="rounded" src="{{asset('uploads/products/'.$image)}}" width="70">
        @endif
        @endforeach
...
<div class="cart-sidebar-footer">
    ...
    <a href="/products/checkout"><button class="btn btn-secondary btn-lg btn-block text-left" type="button"
            onclick="checkout(this)"><span class="float-left"><i class="mdi mdi-cart-outline"></i> Proceed to Checkout
