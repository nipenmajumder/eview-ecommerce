            ...
            <div class="col-sm-6">
                <nav aria-label="breadcrumb" class="theme-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ $reReReSubCategory->name }}</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-3 collection-filter">
                    ...
                    <div class="collection-filter-block">
                        ...
                        @if($reReReSubCategory!=null)
                        <div class="collection-collapse-block open">
                            <h3 class="collapse-block-title">Sub Category</h3>
                            <div class="collection-collapse-block-content">
                                <div class="collection-brand-filter">
                                    @foreach ($reReReSubCategory->reReReSubCategory as $re_re_sub_category)
                                    <div class="form-check collection-filter-checkbox">
                                        <input type="checkbox" class="form-check-input" id="zara">
                                        <label class="form-check-label" for="zara">{{ $re_re_sub_category->name
                                            }}</label>
