            ...
            <div class="col-sm-6">
                <nav aria-label="breadcrumb" class="theme-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ $reSubCategory->name }}</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-3 collection-filter">
                    ...
                    <div class="collection-filter-block">
                        ...
                        @if($reSubCategory!=null)
                        <div class="collection-collapse-block open">
                            <h3 class="collapse-block-title">Sub Category</h3>
                            <div class="collection-collapse-block-content">
                                <div class="collection-brand-filter">
                                    @foreach ($reSubCategory->reReSubCategory as $re_re_sub_category)
                                    <div class="form-check collection-filter-checkbox">
                                        <input type="checkbox"
                                            class="form-check-input common_selector re_re_sub_category"
                                            name="re_re_sub_category" id="{{ $re_re_sub_category->id}}"
                                            value="{{ $re_re_sub_category->id}}">
                                        <label class="form-check-label" for="{{ $re_re_sub_category->id}}">{{
                                            $re_re_sub_category->name
                                            }}</label>
                                    </div>
                                    @endforeach
                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="product-filter-content">
                                                    <div class="search-count">
                                                        <h5>Showing {{ $reSubCategory->name }} Products </h5>
                                                    </div>
...
<script>
    $(document).ready(function(){   
        ...
        {
            var re_sub_category = $('#re_sub_category').val();
            var brand = get_filter('brand');
            var re_re_sub_category = get_filter('re_re_sub_category');
            var price = get_filter('price');
            var sortingval = get_sort();
           $.ajax({
                url : '{{url('/filter-re-sub-category-shop')}}',
                type : 'get',
                data : {re_sub_category:re_sub_category,brand:brand,re_re_sub_category:re_re_sub_category,price:price,sortingval:sortingval},
