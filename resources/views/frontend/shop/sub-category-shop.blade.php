            ...
            <div class="row">
                <div class="col-sm-3 collection-filter">
                    ...
                    <div class="collection-filter-block">
                            ...
                            <div class="collection-collapse-block-content">
                                <div class="collection-brand-filter">
                                    ...
                                    <div class="form-check collection-filter-checkbox">
                                        <input type="checkbox" class="form-check-input re_sub_category common_selector"
                                            name="re_sub_category" id="{{ $re_sub_category->id }}"
                                            value="{{ $re_sub_category->id }}">
                                        <label class="form-check-label" for="{{ $re_sub_category->id }}">{{
                                            $re_sub_category->name }}</label>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        @endif
                        <input type="hidden" name="sub_category" id="sub_category" class="sub_category"
                                            ...
                                            <div class="col-12">
                                                <div class="product-filter-content">
                                                    <div class="search-count">
                                                        <h5>Showing {{ $subCategory->name }} Products </h5>
                                                    </div>
...
<script>
    $(document).ready(function(){   
        function filter_data()
        {
           ...
           $.ajax({
                url : '{{url('/filter-sub-category-shop')}}',
                type : 'get',
                data : {sub_category:sub_category,brand:brand,re_sub_category:re_sub_category,price:price,sortingval:sortingval},
