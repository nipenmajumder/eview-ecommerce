                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6 sub-title">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="{{ asset('frontend/assets') }}/images/icon/logo/f11.png" alt=""></div>
                            ...
                            <ul class="contact-list">
                                ...
                                <li><i class="fa fa-envelope-o"></i>Email Us: <a href="#">{{ $companyInformation->email }}</a></li>
                            </ul>
                        </div>
                    </div>
