                ...
                <div class="col-lg-6">
                    <div class="header-contact">
                        <ul>
                            ...
                            <li><i class="fa fa-phone" aria-hidden="true"></i>Call Us: {{ $companyInformation->mobile }}</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="main-menu">
                    <div class="menu-left">
                        ...
                        <div class="brand-logo">
                            <a href="{{ url('/') }}"><img src="{{asset('uploads/logo/'.$companyInformation->logo)}}"  class="blur-up lazyload" height="70px" weight="70px" alt=""></a>
                        </div>
                    </div>
                    <div>
                                            ...
                                            <div class="row m-0">
                                                ...
                                                <div class="col-xl-4">
                                                    <a href="#" class="mega-menu-banner"><img
                                                            src="{{ asset('frontend/assets') }}/images/mega-menu/fashion.jpg" alt=""
