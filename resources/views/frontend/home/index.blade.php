                    ...
                    <div class="product-box product-wrap product-style-3">
                        <div class="img-wrapper">
                            ...
                            <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                        class="ti-heart" aria-hidden="true"></i></a> <a class="productdetails"
                                    data-id="{{ $product->id }}" href="#" data-bs-toggle="modal"
                                    data-bs-target="#quick-view" title="Quick View"><i class="ti-search"
                    ...
                    <div class="product-box product-wrap product-style-3">
                        <div class="img-wrapper">
                            ...
                            <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                ...
                                <a class="productdetails" data-id="{{ $product->id }}" href="#" data-bs-toggle="modal"
                                    data-bs-target="#quick-view" title="Quick View"><i class="ti-search"
                                        aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i
                    ...
                    <div class="product-box product-wrap product-style-3">
                        <div class="img-wrapper">
                            ...
                            <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                ...
                                <a href="#" class="productdetails" data-id="{{ $product->id }}" data-bs-toggle="modal"
                                    data-bs-target="#quick-view" title="Quick View"><i class="ti-search"
                                        aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i
                                        class="ti-reload" aria-hidden="true"></i></a>
                            </div>
...
<section class="pt-0 section-b-space">
    <div class="container">
        <div class="full-banner custom-space p-right text-end">
            <img src="{{ asset('frontend/assets') }}/images/marketplace/banner/15.jpg" alt=""
