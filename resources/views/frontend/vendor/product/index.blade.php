                                            ...
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <i class="fa fa-pencil-square-o me-1 editshop" data-id="{{ $data->id }}" aria-hidden="true"  data-bs-toggle="modal" data-bs-target="#kt_modal_new_address_update" ></i>
                                                            <a id="delete" href="{{ url('vendor/shop/delete/'.$data->id) }}"><i class="fa fa-trash-o ms-1" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
